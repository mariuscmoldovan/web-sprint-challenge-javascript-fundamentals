...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
  ...
  // Because both are within the function scope of myFunction. 
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){
    /*Your Code Here*/
    const lowerCaseList = zooAnimals.map(item => item.animal_name.toLowerCase());
  ...
  */
  ...
  function lowPopulationAnimals(){
    /*Your Code Here*/
    const lowerPopulationCount = zooAnimals.filter(item => item.population < 5);
    return lowerPopulationCount;
  }
  ...
  */
  ...
  function USApop(){
    /*Your Code Here*/
    const totalAnimalPopulation = zooAnimals.reduce((accumulator, item) => accumulator + item.population, 0);
...
class CubeMaker extends CuboidMaker {
  constructor(attr){
    super({width:attr, length:attr, height:attr})
  }
  volume(){
...
let cubes = new CubeMaker(2)

console.log("Strech Cube volume: ", cubes.volume())

console.log(" Strech Cube surface: ", cubes.surfaceArea())
